...
//    RobotPosition[]  BLUE_3 = new RobotPosition[4];
    ...
    public void populateInitValue() {
        ...
        p[2].x= 359;
        p[2].y = 353;
        this.stoneScanPoints = new HashMap<StartPosition, Point[]>();
        this.stoneScanPoints.put(StartPosition.RED_2, p);  //leftMost 1st block is [0], 3rd block is[2]
        ...
        p2[2].x= 393;
        p2[2].y = 354;
        this.stoneScanPoints.put(StartPosition.RED_3, p2);
        ...
        p3[2].x= 98;
        p3[2].y = 357;
        this.stoneScanPoints.put(StartPosition.BLUE_2, p3);
        ...
        hardwareSpec.clampAngleNormal = 0.795; //0.795; // It should be 0.825 after fix
         ...
         */
        hardwareSpec.clampS1Init = 0.56; //0.45;
        ...
        hardwareSpec.clampS2Init = 0.79;  //auto
        ...
        hardwareSpec.hookS0Close = 0.675;//left side hook, 0.675;
        hardwareSpec.hookS1Open = 0.65;
        hardwareSpec.hookS1Close = 0.195;//right side hook 0.195;
        hardwareSpec.capStoneUp = 0.63;
        hardwareSpec.capStoneDown = 0.35;
        hardwareSpec.capStoneOther = 0.67;
